...
class ControllerPlayer:
	...
	def add_player_to_tournament():
		...
		return View.print_player(ModelPlayer.p_nb, player)
	...
	def print_player_ranking():
		...
		for i in range(0,8):
			if p_n in ModelPlayer.tournament_players[i].family_name:
				...
				p_r = player_ranking
				return View.print_player_ranking(p_n, p_r)
	...
	def change_ranking():
		...
		for i in range(0,8):
			if p_n in ModelPlayer.tournament_players[i].family_name:
				...
				return View.print_player_new_ranking(p_n, new_ranking) 
...
if __name__ == "__main__":
	...
	for _ in range(1,4):
		...
		print(ModelPlayer.tournament_players)
